...
function HeaderHorizontal({
  ...
  const SUBTABS = {
    ...
    invest: [
      ...
      { id: "trade-radar",     label: "Radar",        icon: Radar },
      { id: "trade-ativo",     label: "Análise Téc.", icon: Sparkles },
      { id: "trade-watchlist", label: "Watchlist",    icon: Bookmark },
      { id: "trade-historico", label: "Histórico",    icon: History },
