  ...
  return createPortal((
    <div onClick={onClose}
      ...
      <div onClick={e => e.stopPropagation()}
           style={{ background: T.card, border: `1px solid ${T.borderHi}`, maxWidth: 520, width: "100%", padding: 32, position: "relative", borderRadius: 16, boxShadow: "0 24px 60px rgba(0,0,0,.6)" }}>
...
function CommandPalette({ onClose, setTab, transacoes, contas, ativos, cartoes }) {
  ...
  return createPortal((
    <div onClick={onClose}
      ...
      <div onClick={e => e.stopPropagation()}
           style={{ background: T.card, border: `1px solid ${T.borderHi}`, maxWidth: 600, width: "100%", borderRadius: 16, boxShadow: "0 24px 60px rgba(0,0,0,.6)" }}>
        ...
        <div style={{ maxHeight: "60vh", overflowY: "auto" }}>
          ...
          {items.map((it, i) => (
            <button
              ...
              <span style={{
                color: T.gold, fontSize: 10, fontWeight: 500, letterSpacing: "0.15em",
