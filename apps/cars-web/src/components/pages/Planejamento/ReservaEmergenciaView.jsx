  ...
  return (
    <div className="fade-up py-8">
      ...
      <div style={{
        ...
        {/* Toggle modo */}
        <div style={{ display: "flex", gap: 4, marginBottom: 14, background: T.bgSoft, padding: 3, borderRadius: 16 }}>
          {[
          ...
          {PRESETS.map(p => {
            ...
            return (
              <button key={p.meses} onClick={() => setMeses(p.meses)}
                ...
                <span style={{ fontSize: 10, opacity: .7, textAlign: "center" }}>{p.desc}</span>
              </button>
            );
          })}
        </div>
        ...
        <div style={{
          ...
          {planoConstrucao?.excede && (
            <div style={{
              ...
              border: `1px solid ${T.red}44`, borderRadius: 16,
