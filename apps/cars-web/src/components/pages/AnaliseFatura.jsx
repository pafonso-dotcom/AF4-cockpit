...
9. Retorne APENAS o JSON, NADA mais.`;
      ...
      const analiseNorm = {
        ...
        itens: itens.map(it => ({
          ...
          // Importação nunca cria fixa: qualquer "fixa" (IA/legado) vira "vista".
  ...
  const exportarFaturaPDF = () => {
    ...
    printHTML(`<!doctype html><html><head><meta charset="utf-8"><title>Fatura · Afinanças</title>
<style>
...
<h1>Afinanças · Análise de Fatura</h1>
...
08/05  IFOOD * PIZZAHUT              67,90`}
                        style={{
                          ...
                          color: T.ink, borderRadius: 16, lineHeight: 1.6,
                        }} />
          ...
          <div style={{ background: T.bgSoft, border: `1px solid ${T.border}`, padding: 24 }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div style={{ color: T.muted, fontSize: 13, lineHeight: 1.5 }}>
                  Claude Sonnet identifica cada compra e sugere categoria. Assinaturas você marca manualmente em Despesas Fixas.
                </div>
              </div>
              <div>
                <div className="flex items-center gap-2 mb-2">
