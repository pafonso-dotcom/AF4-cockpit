...
<title>AF4 · Relatório · ${new Date().toLocaleDateString("pt-BR")}</title>
...
<style>
  * { box-sizing: border-box; }
  ...
  <div class="header">
    ...
    <h1><em>AF4</em> · Painel de Comando</h1>
  ...
  <div class="footer">
    <em>finis</em><br>
    AF4 · Painel de Comando · Gerado em ${new Date().toLocaleString("pt-BR")}
  </div>
</body></html>`;
};
