...
export const NAV_ITEMS = [
  ...
  { modulo: "invest", tab: "simulador",      label: "Simuladores",         grupo: "Investimentos" },
  { modulo: "invest", tab: "simulador",      label: "FIIs × Renda Fixa",   grupo: "Investimentos" },
  { modulo: "invest", tab: "calc-renda",     label: "Calculadora de Renda", grupo: "Investimentos" },
