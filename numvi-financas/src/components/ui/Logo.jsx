 ...
 * Wordmark: "NUMVI" sans-serif bold numa linha — "NUM" dourado, "VI" em bordô,
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" role="img" aria-label="NUMVI"
      ...
      <text x="32" y="33" textAnchor="middle" dominantBaseline="central"
            fontFamily="'Nunito', system-ui, sans-serif" fontWeight="800" fontSize="28"
            fill={BORDO}>N</text>
    </svg>
  );
}

// Alias de compatibilidade — alguns lugares ainda importam AF4Mark.
